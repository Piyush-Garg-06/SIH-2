    ...
    export const getAdminDashboard = async (req, res) => {
      try {
        ...
        const dashboardData = {
          ...
          cards: [
              { icon: 'Users', title: 'All Workers', path: '/workers', color: 'blue' },
              { icon: 'Stethoscope', title: 'Doctors', path: '/doctors', color: 'green' },
              { icon: 'Shield', title: 'Health Monitoring', path: '/health-monitoring', color: 'red' },
              { icon: 'BarChart3', title: 'System Reports', path: '/reports', color: 'purple' }
          ],
          alerts: [],
        };
        res.json(dashboardData);
